  ...
  return (
    <div>
        ...
        <div className='projectGrid'>
            ...
            <div className='projectCard'>
                <div className='artel'>
                    <img className='pokeohImg' src="./assets/pokeoh2.png" alt='recipe app'/>
                </div>
                <div className='icons'>
                    <a href="https://github.com/fxhanloniii/pokeoh-project1" target='_blank' rel='noopener noreferrer'>
                        <div className="button">
                            <div className="label">Github</div>
                    ...
                    <a href="https://fxhanloniii.github.io/pokeoh-project1/" target='_blank' rel='noopener noreferrer'>
                        <div className="button">
                            <div className="label">Live Website</div>
                            <img className="icon" src="./assets/globe.png" alt="website"/> 
                        </div>
                ...
                <div className='description'>
                    <p>My Very First Project I ever Completed!! "Poké-Oh" is an exciting game where players select their favorite characters and battle against each other using unique moves and animations. The repository contains all the code for the game, including the HTML, CSS, and JavaScript files and Screenshots/Sketches. With intuitive user interface design, it is easy to navigate through the game.</p>
                </div>
            </div>
            <div className='projectCard'>
                <div className='artel'>
